...
import { DhenzeAssistantWorkspace } from '../components/dhenze-assistant/DhenzeAssistantWorkspace';
...
interface DhenzeLawFirmPublicPageProps {
  onNavigate?: (path: string) => void;
}

export const DhenzeLawFirmPublicPage: React.FC<DhenzeLawFirmPublicPageProps> = ({
  onNavigate,
}) => {
  ...
  const scrollToAssistant = () => {
    const el = document.getElementById('dhenze-assistant-section');
    if (el) {
  ...
  return (
    <div
      id="dhenze-law-firm-public-page"
    ...
    >
      ...
      <header className="sticky top-0 z-40 border-b border-neutral-200 bg-white/95 backdrop-blur-xs">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          {/* Left: Black-and-white DHENZE Logo & Wordmark */}
          <div
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 py-12 sm:py-20 space-y-24">
        ...
        >
          <h2 className="font-serif text-2xl font-bold tracking-tight text-neutral-950">
            About Dhenze Law Firm
          </h2>
          <p className="text-sm sm:text-base text-neutral-700 leading-relaxed font-normal">
            Dhenze Law Firm provides a professional digital environment where clients can access
        ...
        {/* 4. Dhenze Assistant Section */}
        <section id="dhenze-assistant-section" className="border-t border-neutral-200 pt-16 space-y-6">
        ...
        >
          <div className="space-y-2">
            <h2 className="font-serif text-2xl font-bold tracking-tight text-neutral-950">
              Contact Dhenze Law Firm
            </h2>
            <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
              Connect with Dhenze Law Firm for legal inquiries, scheduled consultations, or enterprise notarial coordination.
            </p>
          </div>
